...
![Version](https://img.shields.io/badge/version-v1.18.11-blue)
...
> The `Updated` date in the `.stignore` header (`2026-09-22`) is the ruleset revision date; the tool release version lives in CHANGELOG (currently `v1.18.11`). One tracks "ruleset revision", the other "tool release" — they may differ and that is expected.
...
#### Option 1: Dart + Flutter Desktop (recommended, primary · v1.18.11)
